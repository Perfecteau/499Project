...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <img style="background-color:transparent;border:none;" class="img-fluid img-thumbnail" src="http://localhost/vhs/app/images/logo.png" alt="">
    </a>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="<?php echo URL ?>home/about/">About Us</a>
        </li>
        <li class="nav-item">
